...
const NLP_PROVIDER = (process.env.NLP_PROVIDER || "heuristic").toLowerCase(); // default: FREE
...
app.get(["/wizard_plus.html", "/wizard_plus"], (req, res) => {
  ...
  if (!fs.existsSync(filePath))
    return res.status(404).send("wizard_plus.html not found in PUBLIC_DIR");
